    ...
    private NavigationBarView.OnItemSelectedListener navListener = new NavigationBarView.OnItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch(item.getItemId()) {
                case R.id.home_item:
                    Intent homeIntent = new Intent(VideoPostSearchActivity.this, MainActivity.class);
                    startActivity(homeIntent);
                    break;
                case R.id.search_item:
                    break;
                case R.id.add_item:
                    Intent publishIntent = new Intent(VideoPostSearchActivity.this, ContentPubActivity.class);
                    startActivity(publishIntent);
                    break;
                case R.id.notifications_item:
                    Intent notificationsIntent = new Intent(VideoPostSearchActivity.this, NotificationsActivity.class);
                    startActivity(notificationsIntent);
                    break;
                case R.id.profile_item:
                    Intent userProfileIntent = new Intent(VideoPostSearchActivity.this, UserProfileActivity.class);
